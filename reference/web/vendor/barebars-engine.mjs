            ...
            function go(bot, top3) {
              switch (top3 - bot) {
                ...
                default:
                  ...
                  return apply3(map15(concat2)(go(bot, pivot)))(go(pivot, top3));
              }
            }
...
var $lazy_fromJson = /* @__PURE__ */ $runtime_lazy2("fromJson", "BareBars.Json", function() {
  return caseJson(function(v) {
    ...
    return new VArray(map4($lazy_fromJson(25))(arr2));
  })(function(obj2) {
    return new VObject(fromFoldable1(map4(function(v) {
...
var many = function(p) {
  return bind2(flip(tailRecM3)(Nil.value)(function(xs) {
    ...
    return pure2(reverse(fromFoldable5(rlist)));
  });
};
...
var pNumber = /* @__PURE__ */ function() {
  var numLexeme = bind3(alt4(satisfy(isDigit))(applyFirst3($$char("-"))(lookAhead(satisfy(isDigit)))))(function(first) {
    return bind3(many(satisfy(isNumChar)))(function(rest) {
      return pure3(singleton3(first) + fromCharArray(rest));
    });
  });
...
var pIdent = /* @__PURE__ */ function() {
  ...
  var identPiece = alt4(map6(singleton3)(satisfy(isIdentChar)))(bracketGroup);
...
var tokenizeTemplate = function(src) {
  ...
  var finalize = function($168) {
    return fromFoldable6(reverse2($168));
  };
...
var parseSeq = function(toks) {
  var done = function(acc) {
    return function(stop) {
      return {
        nodes: fromFoldable7(reverse2(acc)),
        stop
      };
    };
  };
...
var runTemplate = function(dictMonad) {
  ...
  var map15 = map(Bind1.Apply0().Functor0());
  ...
  return function(engine) {
    var renderTemplate = function(env) {
      return function(nodes) {
        return map15(joinWith(""))(traverse12(renderNode(env))(nodes));
      };
    };
...
var stringify2 = function(v) {
  ...
  if (v instanceof VArray) {
    return map9(joinWith(","))(traverse3(stringify2)(v.value0));
  }
  ;
...
var renderJson = function(mIndent) {
  return function(depth) {
    ...
    return function(v) {
      ...
      ;
      if (v instanceof VObject) {
        return container("{")("}")(map12(member)(toUnfoldable4(v.value0)));
      }
      ;
...
var segment = function(v) {
  ...
  if (v instanceof Lit && v.value0 instanceof VNumber) {
    return str(show8(v.value0.value0));
  }
  ;
  if (v instanceof App2) {
    return str(v.value0);
...
var rexpr = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at FullBars.JS (line 161, column 9 - line 170, column 99): " + [v.constructor.name]);
};
var path = function(args) {
  ...
  if (v instanceof Just && (v.value0.head instanceof App2 && (v.value0.head.value0 === "this" && v.value0.head.value1.length === 0))) {
    ...
    ;
    return obj([tt2("path"), new Tuple("segments", arr(map14(segment)(v.value0.tail)))]);
  }
  ;
  return obj([tt2("call"), new Tuple("name", str("lookup")), new Tuple("args", arr(map14(argOf)(args)))]);
};
...
var $lazy_rnode = /* @__PURE__ */ $runtime_lazy6("rnode", "FullBars.JS", function() {
  var children = function(ns) {
    return arr(map14($lazy_rnode(137))(ns));
  };
  return function(v) {
    ...
    if (v instanceof ROut) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.JS (line 111, column 21 - line 118, column 10): " + [v1.constructor.name]);
    }
    ;
    if (v instanceof RIf) {
    ...
    var v1 = function(v2) {
      var v3 = function(v4) {
        ...
        ;
        throw new Error("Failed pattern match at FullBars.JS (line 106, column 1 - line 106, column 23): " + [v.constructor.name]);
      };
...
var astJson = function(dialect, src) {
  ...
  if (v instanceof Right) {
    ...
    return obj([new Tuple("ast", obj([new Tuple("version", str("barebars-ast/v1")), new Tuple("nodes", arr(map14(rnode)(nodes)))]))]);
  }
  ;
  throw new Error("Failed pattern match at FullBars.JS (line 57, column 33 - line 78, column 10): " + [v.constructor.name]);
};
export {
  astJson,
  render,

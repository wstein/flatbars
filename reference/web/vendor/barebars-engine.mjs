          ...
          return function(array) {
            function go(bot, top3) {
              switch (top3 - bot) {
                ...
                case 2:
                  return apply3(map19(array2)(f(array[bot])))(f(array[bot + 1]));
                case 3:
                  return apply3(apply3(map19(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                default:
                  var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                  return apply3(map19(concat2)(go(bot, pivot)))(go(pivot, top3));
              }
            }
          ...
          return function($copy_b) {
            ...
            function $tco_loop(a, b) {
              ...
              if (v instanceof IterNext) {
                var v2 = stepAsc(b);
                if (v2 instanceof IterNext && (eq14(v.value0)(v2.value0) && eq24(v.value1)(v2.value1))) {
                  $tco_var_a = v.value2;
                  $copy_b = v2.value2;
                  return;
                }
      ...
      return function(main) {
        ...
        var node = function(ctx2) {
          return function(v) {
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Compile (line 110, column 14 - line 121, column 97): " + [v.constructor.name]);
          };
        };
        ...
        var $lazy_registry = $runtime_lazy2("registry", "BareBars.Compile", function() {
          ...
          ;
          throw new Error("Failed pattern match at BareBars.Compile (line 99, column 3 - line 99, column 21): ");
        });
        var registry = $lazy_registry(99);
...
var DirectiveError = /* @__PURE__ */ function() {
  function DirectiveError2(value0) {
    this.value0 = value0;
  }
  ;
  DirectiveError2.create = function(value0) {
    return new DirectiveError2(value0);
  };
...
var parseErrorOffset = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Error (line 68, column 20 - line 78, column 24): " + [v.constructor.name]);
};
var parseErrorMessage = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Error (line 49, column 21 - line 61, column 48): " + [v.constructor.name]);
};
...
var renderError = function(v) {
  ...
  if (v instanceof DirectiveError) {
    return "DirectiveError: " + v.value0;
  }
  ;
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Error (line 122, column 15 - line 129, column 61): " + [v.constructor.name]);
};
var showError = {
  show: renderError
};
    ...
    return function(pat) {
      ...
      var go = function($copy_i) {
        ...
        function $tco_loop(i) {
          ...
          ;
          throw new Error("Failed pattern match at BareBars.Lexer (line 78, column 3 - line 81, column 29): " + [i.constructor.name]);
        }
        ;
        while (!$tco_done) {
          $tco_result = $tco_loop($copy_i);
...
var tokenizeTemplate = function(src) {
  ...
  var rawName = function(s) {
    return fromCharArray(takeWhile(function($228) {
      return !isSpace2($228);
  ...
  var finalize = function($229) {
    return fromFoldable5(reverse2($229));
  };
  ...
  var openerLiteralAt = function(i) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 276, column 3 - line 276, column 41): " + [i.constructor.name]);
  };
  var isSeparatorAt = function(i) {
    return matchAt(cs)(i)("{{") && (!matchAt(cs)(i)("{{{") && function() {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Lexer (line 294, column 70 - line 296, column 20): " + [v.constructor.name]);
    }());
  };
  var escapedOpenerAt = function(i) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 305, column 23 - line 307, column 62): " + [v.constructor.name]);
  };
  var isOpenerAt = function(i) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 299, column 18 - line 301, column 31): " + [v.constructor.name]);
  };
  ...
  var readBlockOpen = function(i) {
    return function(opener) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Lexer (line 362, column 7 - line 373, column 16): " + [v.constructor.name]);
    };
  };
  var readClose = function(i) {
    return function(opener) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Lexer (line 380, column 7 - line 391, column 16): " + [v.constructor.name]);
    };
  };
  var readLongComment = function(i) {
    return function(opener) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Lexer (line 438, column 30 - line 441, column 89): " + [v.constructor.name]);
    };
  };
  var readOutput = function(i) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 344, column 7 - line 355, column 16): " + [v.constructor.name]);
  };
  var readRaw = function(i) {
    ...
    if (v instanceof Just) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Lexer (line 459, column 13 - line 470, column 22): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 448, column 7 - line 470, column 22): " + [v.constructor.name]);
  };
  var readSeparator = function(i) {
    var start = function() {
      var $134 = leadTrimAt(i);
      if ($134) {
        return i + 3 | 0;
      }
      ;
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 401, column 7 - line 412, column 16): " + [v.constructor.name]);
  };
  var readShortComment = function(i) {
    return function(opener) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Lexer (line 423, column 7 - line 435, column 16): " + [v.constructor.name]);
    };
  };
  var readTag = function(i) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 309, column 3 - line 309, column 48): " + [i.constructor.name]);
  };
              ...
              if (otherwise) {
                ...
                if (v instanceof Just) {
                  if (v.value0 === "\\") {
                    ...
                    ;
                    throw new Error("Failed pattern match at BareBars.Lexer (line 234, column 20 - line 240, column 87): " + [v1.constructor.name]);
                  }
                  ;
                  if (v.value0 === "{" && isOpenerAt(i)) {
                    ...
                    ;
                    throw new Error("Failed pattern match at BareBars.Lexer (line 243, column 41 - line 250, column 57): " + [v1.constructor.name]);
                  }
                  ;
                  if (otherwise) {
                    $tco_var_i = i + 1 | 0;
                ...
                ;
                throw new Error("Failed pattern match at BareBars.Lexer (line 226, column 19 - line 251, column 60): " + [v.constructor.name]);
              }
              ;
              throw new Error("Failed pattern match at BareBars.Lexer (line 217, column 3 - line 223, column 39): " + [i.constructor.name, segStart.constructor.name, frags.constructor.name, acc.constructor.name, pend.constructor.name]);
            }
            ;
            while (!$tco_done) {
...
var dropTrailingIndent = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Lexer (line 187, column 24 - line 189, column 16): " + [v.constructor.name]);
};
var dropLeadingLine = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Lexer (line 180, column 21 - line 182, column 16): " + [v.constructor.name]);
};
...
var beforeFirstNL = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Lexer (line 173, column 19 - line 175, column 15): " + [v.constructor.name]);
};
var allWs = /* @__PURE__ */ function() {
  var $230 = all2(isSpace2);
  return function($231) {
    return $230(toCharArray($231));
  };
}();
var afterLastNL = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Lexer (line 168, column 17 - line 170, column 15): " + [v.constructor.name]);
};
var trimStandalone = function(toks) {
  var n = length(toks);
  var rightBlank = function(i) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 139, column 18 - line 144, column 20): " + [v.constructor.name]);
  };
  var leftBlank = function(i) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Lexer (line 132, column 17 - line 135, column 20): " + [v.constructor.name]);
  };
  var standaloneAt = function(i) {
    var v = index(toks)(i);
    if (v instanceof Just && blockLevel(v.value0)) {
...
var outputExpr = function(span3) {
  return function(base) {
    return function(s) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Parser (line 177, column 1 - line 177, column 62): " + [span3.constructor.name, base.constructor.name, s.constructor.name]);
    };
  };
};
  ...
  return function(interior) {
    ...
    var valueEnd = function($copy_k) {
      ...
      function $tco_loop(k) {
        ...
        ;
        throw new Error("Failed pattern match at BareBars.Parser (line 129, column 3 - line 132, column 35): " + [k.constructor.name]);
      }
      ;
      while (!$tco_done) {
    ...
    var readKey = function($copy_k) {
      ...
      var $tco_result;
      function $tco_loop(k) {
        var $33 = maybe(false)(isKeyChar)(at(k));
        if ($33) {
          $copy_k = k + 1 | 0;
          return;
        }
    ...
    var skipWs = function($copy_k) {
      ...
      var $tco_result;
      function $tco_loop(k) {
        var $34 = maybe(false)(isSpace3)(at(k));
        if ($34) {
          $copy_k = k + 1 | 0;
          return;
        }
    ...
    var go = function($copy_j) {
      return function($copy_acc) {
        ...
        function $tco_loop(j, acc) {
          ...
          ;
          throw new Error("Failed pattern match at BareBars.Parser (line 134, column 3 - line 134, column 50): " + [j.constructor.name, acc.constructor.name]);
        }
        ;
        while (!$tco_done3) {
  ...
  return function(base) {
    return function(s) {
      ...
      if (otherwise) {
        ...
        ;
        throw new Error("Failed pattern match at BareBars.Parser (line 187, column 17 - line 190, column 48): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at BareBars.Parser (line 184, column 1 - line 184, column 92): " + [span3.constructor.name, base.constructor.name, s.constructor.name]);
    };
  };
};
      ...
      function $tco_loop(acc, i) {
        ...
        if (v instanceof Just) {
          ...
          if (v.value0 instanceof ROutput) {
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Parser (line 226, column 30 - line 228, column 52): " + [v1.constructor.name]);
          }
          ;
          if (v.value0 instanceof RRaw) {
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Parser (line 229, column 32 - line 231, column 71): " + [v1.constructor.name]);
          }
          ;
          if (v.value0 instanceof RSep) {
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Parser (line 232, column 27 - line 234, column 61): " + [v1.constructor.name]);
          }
          ;
          if (v.value0 instanceof RClose) {
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Parser (line 235, column 26 - line 237, column 63): " + [v1.constructor.name]);
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at BareBars.Parser (line 223, column 15 - line 238, column 62): " + [v.value0.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at BareBars.Parser (line 221, column 14 - line 238, column 62): " + [v.constructor.name]);
      }
      ;
      while (!$tco_done) {
          ...
          return function(i) {
            ...
            if (v instanceof Right) {
              ...
              if (v1 instanceof Right) {
                ...
                ;
                throw new Error("Failed pattern match at BareBars.Parser (line 245, column 22 - line 250, column 73): " + [v1.value0.stop.constructor.name]);
              }
              ;
              throw new Error("Failed pattern match at BareBars.Parser (line 243, column 16 - line 250, column 73): " + [v1.constructor.name]);
            }
            ;
            throw new Error("Failed pattern match at BareBars.Parser (line 241, column 34 - line 250, column 73): " + [v.constructor.name]);
          };
        };
      };
    };
...
var effectiveTrim = function(opts) {
  return function(directives) {
    ...
    ;
    throw new Error("Failed pattern match at BareBars.Parser (line 76, column 33 - line 84, column 8): " + [v.constructor.name]);
  };
};
      ...
      return function($copy_acc) {
        ...
        function $tco_loop(i, headerOpen, acc) {
          ...
          if (v instanceof Just && v.value0 instanceof RComment) {
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Parser (line 107, column 14 - line 109, column 42): " + [v1.constructor.name]);
          }
          ;
          if (v instanceof Just && v.value0 instanceof RContent) {
            $tco_var_i = i + 1 | 0;
          ...
          ;
          throw new Error("Failed pattern match at BareBars.Parser (line 100, column 25 - line 111, column 35): " + [v.constructor.name]);
        }
        ;
        while (!$tco_done) {
      ...
      return bind4(collectDirectives(toks))(function(directives) {
        return bind4(effectiveTrim(opts)(directives))(function(standalone) {
          var toks$prime = function() {
            if (standalone) {
              return trimStandalone(toks);
            }
            ;
            return toks;
          }();
          return bind4(parseSeq(filter(function($114) {
            return !isComment($114);
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Parser (line 63, column 3 - line 65, column 63): " + [res.stop.constructor.name]);
          });
        });
      });
    });
...
var runTemplate = function(dictMonad) {
  ...
  var map19 = map(Bind1.Apply0().Functor0());
  ...
  return function(engine) {
    var renderTemplate = function(env) {
      return function(nodes) {
        return map19(joinWith(""))(traverse12(renderNode(env))(nodes));
      };
    };
...
var ordFalsyShape = {
  compare: function(x) {
    return function(y) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Value (line 0, column 0 - line 0, column 0): " + [x.constructor.name, y.constructor.name]);
    };
  },
  Eq0: function() {
    return eqFalsyShape;
...
var shapeOf = function(v) {
  ...
  ;
  return note(new DirectiveError("unknown @truthiness value '" + (v + "'")))(Nothing.value);
};
...
var stringify = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at FullBars.Value (line 173, column 13 - line 180, column 61): " + [v.constructor.name]);
};
...
var renderJson = function(mIndent) {
  return function(depth) {
    var container = function(open) {
      return function(close) {
        return function(items) {
          ...
          ;
          throw new Error("Failed pattern match at FullBars.Value (line 229, column 32 - line 237, column 17): " + [mIndent.constructor.name]);
        };
      };
    };
    var colon = function() {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Value (line 224, column 11 - line 226, column 19): " + [mIndent.constructor.name]);
    }();
    ...
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Value (line 212, column 28 - line 221, column 70): " + [v.constructor.name]);
    };
  };
};
...
var isFalsy = function($copy_fs) {
  return function($copy_v) {
    ...
    function $tco_loop(fs, v) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Value (line 78, column 14 - line 86, column 36): " + [v.constructor.name]);
    }
    ;
    while (!$tco_done) {
...
var parseTruthiness = function(value) {
  ...
  if (v instanceof Nothing) {
    var v1 = tokens(value);
    if (v1.length === 0) {
      return new Left(new DirectiveError("empty @truthiness value; use the 'always' alias for nothing-falsy"));
    }
    ;
    return map9(fromFoldable8)(traverse3(shapeOf)(v1));
  }
  ;
  throw new Error("Failed pattern match at FullBars.Value (line 143, column 25 - line 147, column 51): " + [v.constructor.name]);
};
var resolveTruthiness = function(directives) {
  ...
  ;
  if (v.length === 1) {
    return parseTruthiness(v[0].value);
  }
  ;
  return new Left(new DirectiveError("duplicate @truthiness directive (at most one per file)"));
};
...
var register = function(name2) {
  return function(h) {
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Env (line 94, column 37 - line 96, column 61): " + [v.helpers.constructor.name]);
    };
  };
};
    ...
    var go = function($copy_v1) {
      ...
      function $tco_loop(v1) {
        ...
        if (v1 instanceof Cons) {
          ...
          ;
          throw new Error("Failed pattern match at FullBars.Env (line 106, column 19 - line 108, column 23): " + [v2.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at FullBars.Env (line 105, column 3 - line 105, column 19): " + [v1.constructor.name]);
      }
      ;
      while (!$tco_done) {
    ...
    return {
      ...
      resolve: function(env) {
        return function(name2) {
          ...
          ;
          throw new Error("Failed pattern match at FullBars.Env (line 144, column 27 - line 146, column 49): " + [v.constructor.name]);
        };
      },
...
var stringifyM = function(dictMonadThrow) {
  var $360 = liftEither(dictMonadThrow);
  return function($361) {
    return $360(stringify($361));
  };
};
...
var pickClause = function(dictMonadThrow) {
  ...
  return function(ctl) {
    return function(clauses) {
        ...
        if (v.value0.head.name === "elif") {
          if (v.value0.head.args.length === 1) {
            return bind5(ctl["eval"](ctl.env)(v["value0"]["head"]["args"][0]))(function(cond) {
              var $238 = truthy(refFalsy(ctl.env))(cond);
              if ($238) {
                return renderSafe1(ctl)(ctl.env)(v.value0.head.body);
              }
              ;
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Prelude (line 304, column 26 - line 314, column 82): " + [v.constructor.name]);
    };
  };
};
    ...
    return function(args) {
      ...
      var renderPartial = function(name2) {
        return function(ctx2) {
          ...
          if (v instanceof Just) {
            var entered = pushFrame(blockFrame)(ctx2)(ctl.env);
            var scoped = function() {
              ...
              ;
              throw new Error("Failed pattern match at FullBars.Prelude (line 504, column 18 - line 506, column 29): " + [v1.constructor.name]);
            }();
          ...
          ;
          throw new Error("Failed pattern match at FullBars.Prelude (line 500, column 28 - line 511, column 63): " + [v.constructor.name]);
        };
      };
  ...
  return function(opts) {
    return function(v) {
      return truthy(function() {
        var $265 = optFlag("includeZero")(opts);
        if ($265) {
          return $$delete4(FZero.value)(fs);
        }
        ;
        return fs;
      }())(v);
    ...
    return function(names) {
      return function(items) {
        ...
        var renderItem = function(i) {
          return function(v) {
            var frame = fromFoldable9(append12([new Tuple("this", constHelper2(v.val)), new Tuple("index", constHelper2(new VNumber(toNumber(i)))), new Tuple("key", constHelper2(new VString(v.key))), new Tuple("first", constHelper2(new VBool(i === 0))), new Tuple("last", constHelper2(new VBool(i === (n - 1 | 0)))), new Tuple("parent", constHelper2(refContext(ctl.env)))])(append12(parentData(ctl))(binds(v.val)(v.idx))));
...
var indexValue = function(v) {
  return function(v1) {
    ...
    if (v instanceof VArray && v1 instanceof VString) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Prelude (line 239, column 38 - line 241, column 19): " + [v2.constructor.name]);
    }
    ;
    return VNull.value;
  };
...
var lookupH = function(dictMonadThrow) {
  ...
  return function(v) {
    return function(args) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Prelude (line 227, column 18 - line 229, column 59): " + [v1.constructor.name]);
    };
  };
};
...
var escJsonH = function(dictMonadThrow) {
  ...
  return function(v) {
    return function(args) {
      return map22(function($364) {
        return VSafe.create(escapeHtml($364));
...
var escHtml = function(dictMonadThrow) {
  ...
  return function(v) {
    ...
    ;
    return map22(function($365) {
      return VSafe.create(escapeHtml($365));
    })(stringifyM1(v));
  };
};
var eq$prime = function(dictApplicative) {
  ...
  return function(a) {
    return function(b) {
      return pure4(new VBool(eq13(a)(b)));
    };
  };
};
        ...
        return function($copy_acc) {
          ...
          function $tco_loop(as, acc) {
            ...
            if (v1 instanceof Just && v1.value0.head instanceof VString) {
              ...
              ;
              throw new Error("Failed pattern match at FullBars.Prelude (line 465, column 39 - line 467, column 73): " + [v2.constructor.name]);
            }
            ;
            if (v1 instanceof Just) {
              $tco_done = true;
            ...
            ;
            throw new Error("Failed pattern match at FullBars.Prelude (line 463, column 18 - line 468, column 66): " + [v1.constructor.name]);
          }
          ;
          while (!$tco_done) {
...
var checkIfClauses = function(dictMonadThrow) {
  ...
  return function(clauses) {
    ...
    ;
    throw new Error("Failed pattern match at FullBars.Prelude (line 321, column 26 - line 330, column 82): " + [v.constructor.name]);
  };
};
...
var eachH = function(dictMonadThrow) {
  ...
  return function(ctl) {
    return function(args) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Prelude (line 367, column 18 - line 384, column 84): " + [v.constructor.name]);
    };
  };
};
var withH = function(dictMonadThrow) {
  ...
  return function(ctl) {
    return function(args) {
      var v = uncons(args);
      if (v instanceof Just) {
        var $349 = truthy(refFalsy(ctl.env))(v.value0.head);
        if ($349) {
          ...
          var frame = fromFoldable9(append12([new Tuple("parent", constHelper2(refContext(ctl.env)))])(append12(parentData(ctl))(binds)));
      ...
      ;
      throw new Error("Failed pattern match at FullBars.Prelude (line 441, column 18 - line 454, column 84): " + [v.constructor.name]);
    };
  };
};
  ...
  return function(ctl) {
    return function(args) {
      ...
      if (v instanceof Just && v.value0.head instanceof VString) {
        ...
        ;
        throw new Error("Failed pattern match at FullBars.Prelude (line 472, column 40 - line 474, column 47): " + [v1.constructor.name]);
      }
      ;
...
var helperDefs = function(dictMonadThrow) {
  ...
  }))), gen("not")(false)(new Exactly(1))(notH(dictMonadThrow)), gen("and")(false)(AnyArity.value)(boolH1(all2)), gen("or")(false)(AnyArity.value)(boolH1(any2)), valDef1("log")(atLeast(dictMonadThrow)(1)($$const(pure4(VNull.value))))];
};
      ...
      if (v instanceof Block && v.value1 === "inline") {
        ...
        if ($91 instanceof Just) {
          ...
          return {
            ...
            partials: insert6($91.value0)(inner.template)(union5(acc.partials)(inner.partials))
          };
        }
        ;
        return v1(true);
  ...
  var go = function(scope) {
    var node = function(v) {
      ...
      if (v instanceof Block) {
        ...
        return new Block(v.value0, v.value1, append13(rewriteArgs(scope)(v1.mainArgs))(map11(function($225) {
          return Lit.create(VString.create($225));
        })(v1.params)), go(append13(scope)(v1.params))(expandElseIf(v.value3)));
      }
      ;
      if (v instanceof RawBlock) {
...
var renderWithDiag = function(src) {
  return function(dat) {
    ...
    ;
    if (v instanceof Right) {
      var v1 = runResolved2(v.value0.directives)(identity8)(v.value0.nodes)(dat);
      if (v1 instanceof Left) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars (line 109, column 34 - line 111, column 27): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at FullBars (line 107, column 26 - line 111, column 27): " + [v.constructor.name]);
  };
};
  ...
  return function(src) {
    return function(dat) {
      ...
      if (v instanceof Right) {
        ...
        ;
        throw new Error("Failed pattern match at FullBars (line 191, column 7 - line 193, column 31): " + [v2.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at FullBars (line 185, column 38 - line 193, column 31): " + [v.constructor.name]);
    };
  };
};
var renderSurfaceDiag = /* @__PURE__ */ renderSurfaceDiagWith(defaultParseOptions);
    ...
    return function(dat) {
      var compilePartial = function(v4) {
        ...
        if (v12 instanceof Right) {
          ...
          ;
          throw new Error("Failed pattern match at FullBars (line 174, column 36 - line 176, column 75): " + [v22.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at FullBars (line 172, column 35 - line 176, column 75): " + [v12.constructor.name]);
      };
      ...
      if (v instanceof Right) {
        ...
        if (v1 instanceof Right) {
          ...
          var setup = function() {
            var $124 = registerPartialsFalsy(externalF);
            var $125 = registerPartials(union6(v2.partials)(externalT));
            return function($126) {
              return $124($125($126));
            };
          }();
          ...
          ;
          throw new Error("Failed pattern match at FullBars (line 166, column 11 - line 168, column 35): " + [v3.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at FullBars (line 155, column 17 - line 168, column 35): " + [v1.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at FullBars (line 153, column 3 - line 168, column 35): " + [v.constructor.name]);
    };
  };
};
...
var litJs = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at BareBars.Compile.FullBars (line 101, column 9 - line 108, column 22): " + [v.constructor.name]);
};
...
var head1 = function(rec) {
  return function(ctx2) {
    return function(args) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Compile.FullBars (line 211, column 22 - line 213, column 20): " + [v.constructor.name]);
    };
  };
};
var elseChain = function(rec) {
  return function(ctx2) {
    return function(clauses) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Compile.FullBars (line 146, column 29 - line 154, column 58): " + [v.constructor.name]);
    };
  };
};
      ...
      return function(args) {
        return function(body) {
          ...
          var elseClause = function() {
            ...
            ;
            throw new Error("Failed pattern match at BareBars.Compile.FullBars (line 168, column 18 - line 170, column 20): " + [v.constructor.name]);
          }();
  ...
  return function(ctx2) {
    return function(args) {
      return function(i) {
        ...
        ;
        throw new Error("Failed pattern match at BareBars.Compile.FullBars (line 96, column 24 - line 98, column 20): " + [v.constructor.name]);
      };
    };
  };
};
var fbExpr = function(rec) {
  return function(ctx2) {
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at BareBars.Compile.FullBars (line 78, column 18 - line 91, column 92): " + [v.constructor.name]);
    };
  };
};
var fullbarsEmit = {
...
var compileCoreWith = function(opts) {
  return function(src) {
    return map16(function(v) {
      return compile({
        runtimeVersion
      })(fullbarsEmit)([])(v.nodes);
    })(parseWith(opts)(src));
  };
};
var compileCore = /* @__PURE__ */ compileCoreWith(defaultParseOptions);
var compileSurfaceWith = function(opts) {
  return function(src) {
    var emitSurface = function(tmpl) {
      ...
      return compile({
        runtimeVersion
      })(fullbarsEmit)(toUnfoldable6(h.partials))(h.template);
    };
    return map16(function(v) {
      return emitSurface(v.nodes);
    })(parseWith(opts)(src));
  };
};
var compileSurface = /* @__PURE__ */ compileSurfaceWith(defaultParseOptions);
...
var fromFoldable11 = function(dictFoldable) {
  var fromFoldable13 = fromFoldable2(dictFoldable);
  return function(l) {
...
var $lazy_fromJson = /* @__PURE__ */ $runtime_lazy6("fromJson", "BareBars.Json", function() {
  return caseJson(function(v) {
    ...
    return new VArray(map17($lazy_fromJson(25))(arr2));
  })(function(obj2) {
    return new VObject(fromFoldable1(map17(function(v) {
...
var rexpr = function(v) {
  ...
  ;
  if (v instanceof App2) {
    return obj([tt2("call"), new Tuple("name", str(v.value0)), new Tuple("args", arr(map18(argOf)(v.value1)))]);
  }
  ;
...
var path = function(args) {
  ...
  if (v instanceof Just && (v.value0.head instanceof App2 && (v.value0.head.value0 === "this" && v.value0.head.value1.length === 0))) {
    ...
    ;
    return obj([tt2("path"), new Tuple("segments", arr(map18(segment)(v.value0.tail)))]);
  }
  ;
  return obj([tt2("call"), new Tuple("name", str("lookup")), new Tuple("args", arr(map18(argOf)(args)))]);
};
...
var $lazy_rnode = /* @__PURE__ */ $runtime_lazy7("rnode", "FullBars.JS", function() {
  var children = function(ns) {
    return arr(map18($lazy_rnode(164))(ns));
  };
  return function(v) {
    ...
    var v1 = function(v2) {
      var v3 = function(v4) {
        if (v instanceof RCall) {
          return obj([tt2(v.value0), new Tuple("args", arr(map18(argOf)(v.value1))), new Tuple("body", children(v.value2))]);
        }
        ;
        if (v instanceof RSep2) {
          return obj([tt2("sep"), new Tuple("name", str(v.value0)), new Tuple("args", arr(map18(argOf)(v.value1)))]);
        }
        ;
...
var astJson = function(dialect, src) {
  ...
  if (v instanceof Right) {
    ...
    return obj([new Tuple("ast", obj([new Tuple("version", str("barebars-ast/v1")), new Tuple("nodes", arr(map18(rnode)(nodes)))]))]);
  }
  ;

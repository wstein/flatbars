...
var $lazy_fromJson = /* @__PURE__ */ $runtime_lazy2("fromJson", "BareBars.Json", function() {
  return caseJson(function(v) {
    return VNull.value;
  })(VBool.create)(VNumber.create)(VString.create)(function(arr) {
    return new VArray(map4($lazy_fromJson(25))(arr));
  })(function(obj) {
...
var pNumber = /* @__PURE__ */ function() {
  var numLexeme = bind3(alt4(satisfy(isDigit))(applyFirst3($$char("-"))(lookAhead(satisfy(isDigit)))))(function(first) {
    return bind3(many(satisfy(isNumChar)))(function(rest) {
      return pure3(singleton6(first) + fromCharArray(rest));
    });
  });
...
var pIdent = /* @__PURE__ */ function() {
  ...
  var identPiece = alt4(map6(singleton6)(satisfy(isIdentChar)))(bracketGroup);
...
var runTemplate = function(dictMonad) {
  ...
  return function(engine) {
    var renderTemplate = function(env) {
      return function(nodes) {
        return map13(joinWith(""))(traverse12(renderNode(env))(nodes));
      };
    };
...
var renderJson = function(mIndent) {
  return function(depth) {
    ...
    return function(v) {
      ...
      ;
      if (v instanceof VObject) {
        return container("{")("}")(map1(member)(toUnfoldable4(v.value0)));
      }
      ;
...
var partialH = function(dictMonadThrow) {
  ...
  return function(ctl) {
    return function(args) {
      var mergeHash = function(ctx) {
        return function(opts) {
          if (opts instanceof VObject) {
            if (ctx instanceof VObject) {
              return new VObject(union4(opts.value0)(ctx.value0));
            }
            ;
      ...
      var renderPartial = function(name2) {
        return function(ctx) {
          ...
          if (v instanceof Just) {
            return map22(VSafe.create)(ctl.render(pushFrame(blockFrame)(ctx)(ctl.env))(v.value0));
          }
          ;
          if (v instanceof Nothing) {
    ...
    return function(args) {
      ...
      if (v instanceof Just) {
        ...
        if (v.value0.head instanceof VObject) {
          ...
          ;
          return iterate1(ctl)(names)(map12(function(v1) {
            return {
              val: v1.value1,
              key: v1.value0,
...
var partialCall = function(scope) {
  return function(nameExpr) {
    return function(valueArgs) {
      ...
      var ctx = maybe(new App2("this", []))(rewrite(scope))(head(h.positional));
      var $172 = $$null(h.pairs);
      if ($172) {
        return [nameExpr, ctx];
      }
      ;
      return [nameExpr, ctx, dictExpr(h.pairs)];
    };
  };
};

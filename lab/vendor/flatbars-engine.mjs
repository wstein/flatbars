...
var sepHead = function(s) {
  ...
  return fromCharArray(takeWhile(function($327) {
    return !isSpace($327);
  })(cs));
};
    ...
    return function(pat) {
      ...
      var go = function($copy_i) {
        ...
        function $tco_loop(i) {
          ...
          ;
          throw new Error("Failed pattern match at FlatBars.Lexer (line 90, column 3 - line 93, column 29): " + [i.constructor.name]);
        }
        ;
        while (!$tco_done) {
          $tco_result = $tco_loop($copy_i);
...
var tokenizeTemplate = function(cfg) {
  return function(src) {
    ...
    var rawName = function(s) {
      return fromCharArray(takeWhile(function($328) {
        return !isSpace($328);
    ...
    var finalize = function($329) {
      return fromFoldable4(reverse2($329));
    };
    var delimWords = function(s) {
      var a0 = dropWhile(isSpace)(toCharArray(s));
      var a1 = dropWhile(isSpace)(dropWhile(function($330) {
        return !isSpace($330);
      })(a0));
      var rest = dropWhile(isSpace)(dropWhile(function($331) {
        return !isSpace($331);
      })(a1));
      var w2 = takeWhile(function($332) {
        return !isSpace($332);
      })(a1);
      var w1 = takeWhile(function($333) {
        return !isSpace($333);
      })(a0);
      var $148 = $$null(w1) || ($$null(w2) || !$$null(rest));
      if ($148) {
        return Nothing.value;
      }
      ;
    ...
    var parseDelimDirective = function(interior) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 363, column 7 - line 370, column 100): " + [v.constructor.name]);
    };
    var delimSwitch = function(v) {
      if (v instanceof Just && (v.value0 instanceof RComment && cfg.mustacheDelims)) {
        ...
        ;
        throw new Error("Failed pattern match at FlatBars.Lexer (line 350, column 58 - line 353, column 39): " + [v1.constructor.name]);
      }
      ;
      return new Right(Nothing.value);
    };
    ...
    var openerLiteralAt = function(i) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 395, column 3 - line 395, column 41): " + [i.constructor.name]);
    };
    var isSeparatorAt = function(i) {
      return matchAt(cs)(i)("{{") && (!matchAt(cs)(i)("{{{") && function() {
        ...
        ;
        throw new Error("Failed pattern match at FlatBars.Lexer (line 424, column 70 - line 426, column 20): " + [v.constructor.name]);
      }());
    };
    var escapedOpenerAt = function(i) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 435, column 23 - line 437, column 62): " + [v.constructor.name]);
    };
    var isOpenerAt = function(i) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 429, column 18 - line 431, column 31): " + [v.constructor.name]);
    };
    ...
    var readAmp = function(i) {
      return function(opener) {
        ...
        ;
        throw new Error("Failed pattern match at FlatBars.Lexer (line 547, column 7 - line 558, column 16): " + [v.constructor.name]);
      };
    };
      ...
      return function(opener) {
        return function(sigil) {
          return function(close) {
            ...
            ;
            throw new Error("Failed pattern match at FlatBars.Lexer (line 507, column 7 - line 518, column 16): " + [v.constructor.name]);
          };
        };
      };
    };
    var readClose = function(i) {
      return function(opener) {
        return function(close) {
          ...
          ;
          throw new Error("Failed pattern match at FlatBars.Lexer (line 528, column 7 - line 539, column 16): " + [v.constructor.name]);
        };
      };
    };
    var readCustomTag = function(i) {
      return function(open) {
        return function(close) {
          ...
          ;
          throw new Error("Failed pattern match at FlatBars.Lexer (line 703, column 7 - line 721, column 49): " + [v.constructor.name]);
        };
      };
    };
    var readLongComment = function(i) {
      return function(opener) {
        ...
        ;
        throw new Error("Failed pattern match at FlatBars.Lexer (line 605, column 30 - line 608, column 89): " + [v.constructor.name]);
      };
    };
    var readOutput = function(i) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 485, column 7 - line 496, column 16): " + [v.constructor.name]);
    };
    var readRaw = function(i) {
      return function(sigil) {
        ...
        if (v instanceof Just) {
          ...
          ;
          throw new Error("Failed pattern match at FlatBars.Lexer (line 628, column 13 - line 639, column 22): " + [v1.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at FlatBars.Lexer (line 617, column 7 - line 639, column 22): " + [v.constructor.name]);
      };
    };
    var readSeparator = function(i) {
      var start = function() {
        var $195 = leadTrimAt(i);
        if ($195) {
          return i + 3 | 0;
        }
        ;
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 568, column 7 - line 579, column 16): " + [v.constructor.name]);
    };
      ...
      return function(open) {
        return function(close) {
          ...
          if (v instanceof Just) {
            ...
            ;
            throw new Error("Failed pattern match at FlatBars.Lexer (line 661, column 19 - line 672, column 88): " + [v1.constructor.name]);
          }
          ;
          throw new Error("Failed pattern match at FlatBars.Lexer (line 658, column 7 - line 672, column 88): " + [v.constructor.name]);
        };
      };
    };
    var readShortComment = function(i) {
      return function(opener) {
        ...
        ;
        throw new Error("Failed pattern match at FlatBars.Lexer (line 590, column 7 - line 602, column 16): " + [v.constructor.name]);
      };
    };
    var readTag = function(i) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 439, column 3 - line 439, column 48): " + [i.constructor.name]);
    };
                    ...
                    if (otherwise) {
                      ...
                      if (v instanceof Just) {
                        if (cfg.mustacheDelims && matchAt(cs)(i)(open + "=")) {
                          ...
                          ;
                          throw new Error("Failed pattern match at FlatBars.Lexer (line 290, column 65 - line 296, column 82): " + [v1.constructor.name]);
                        }
                        ;
                        if (open === "{{" && (close === "}}" && v.value0 === "\\")) {
                          var $217 = matchAt(cs)(i + 1 | 0)("\\");
                          if ($217) {
                            $tco_var_i = i + 2 | 0;
                            $tco_var_open = open;
                            $tco_var_close = close;
                          ...
                          ;
                          throw new Error("Failed pattern match at FlatBars.Lexer (line 304, column 20 - line 310, column 98): " + [v1.constructor.name]);
                        }
                        ;
                        if (open === "{{" && (close === "}}" && (v.value0 === "{" && isOpenerAt(i)))) {
                          ...
                          if (v1 instanceof Right) {
                            ...
                            ;
                            throw new Error("Failed pattern match at FlatBars.Lexer (line 317, column 19 - line 320, column 92): " + [v2.constructor.name]);
                          }
                          ;
                          throw new Error("Failed pattern match at FlatBars.Lexer (line 311, column 74 - line 320, column 92): " + [v1.constructor.name]);
                        }
                        ;
                        if (open === "{{" && close === "}}") {
                          $tco_var_i = i + 1 | 0;
                        ...
                        if (matchAt(cs)(i)(open)) {
                          ...
                          if (v1 instanceof Right) {
                            ...
                            ;
                            throw new Error("Failed pattern match at FlatBars.Lexer (line 330, column 19 - line 333, column 92): " + [v2.constructor.name]);
                          }
                          ;
                          throw new Error("Failed pattern match at FlatBars.Lexer (line 324, column 34 - line 333, column 92): " + [v1.constructor.name]);
                        }
                        ;
                        if (otherwise) {
                          $tco_var_i = i + 1 | 0;
                      ...
                      ;
                      throw new Error("Failed pattern match at FlatBars.Lexer (line 284, column 19 - line 334, column 71): " + [v.constructor.name]);
                    }
                    ;
                    throw new Error("Failed pattern match at FlatBars.Lexer (line 273, column 3 - line 281, column 39): " + [i.constructor.name, open.constructor.name, close.constructor.name, segStart.constructor.name, frags.constructor.name, acc.constructor.name, pend.constructor.name]);
                  }
                  ;
                  while (!$tco_done) {
...
var dropTrailingIndent = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at FlatBars.Lexer (line 219, column 24 - line 221, column 16): " + [v.constructor.name]);
};
var dropLeadingLine = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at FlatBars.Lexer (line 212, column 21 - line 214, column 16): " + [v.constructor.name]);
};
...
var beforeFirstNL = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at FlatBars.Lexer (line 205, column 19 - line 207, column 15): " + [v.constructor.name]);
};
var allWs = /* @__PURE__ */ function() {
  var $336 = all2(isSpace);
  return function($337) {
    return $336(toCharArray($337));
  };
}();
var afterLastNL = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at FlatBars.Lexer (line 200, column 17 - line 202, column 15): " + [v.constructor.name]);
};
var trimStandalone = function(seps) {
  return function(toks) {
    ...
    var rightBlank = function(i) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 160, column 18 - line 165, column 20): " + [v.constructor.name]);
    };
    var leftBlank = function(i) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Lexer (line 153, column 17 - line 156, column 20): " + [v.constructor.name]);
    };
...
var sigilKind = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at FlatBars.Highlight (line 89, column 13 - line 93, column 27): " + [v.constructor.name]);
};
var isSpace2 = function(c) {
  return c === " " || (c === "	" || (c === "\n" || c === "\r"));
};
var trimmedChars = /* @__PURE__ */ function() {
  var $41 = dropWhile(isSpace2);
  return function($42) {
    return $41(toCharArray($42));
  };
}();
...
var headWord = function(s) {
  return fromCharArray(takeWhile(function($43) {
    return !isSpace2($43);
  })(trimmedChars(s)));
};
var highlightSpans = function(cfg) {
  return function(src) {
    var sepKind = function(interior) {
      if (isPartialHead(interior)) {
        return "partial";
      }
      ;
      if (elem4(headWord(interior))(cfg.clauseSeps)) {
        return "keyword";
      }
      ;
      if (otherwise) {
      ...
      ;
      throw new Error("Failed pattern match at FlatBars.Highlight (line 82, column 3 - line 82, column 30): " + [interior.constructor.name]);
    };
    var at = function(sp) {
    ...
    var spanOf = function(v2) {
      ...
      if (v2 instanceof ROpen) {
        return at(v2.value0)(sigilKind(v2.value1));
      }
      ;
      if (v2 instanceof RClose) {
        return at(v2.value0)("block-close");
      }
      ;
      if (v2 instanceof RSep) {
        return at(v2.value0)(sepKind(v2.value2));
      }
      ;
      if (v2 instanceof RRaw) {
        return at(v2.value0)("raw-block");
      }
      ;
      if (v2 instanceof RComment) {
        return at(v2.value0)("comment");
      }
      ;
      if (v2 instanceof RSetDelim) {
        return at(v2.value0)("set-delimiter");
      }
      ;
      throw new Error("Failed pattern match at FlatBars.Highlight (line 64, column 12 - line 73, column 42): " + [v2.constructor.name]);
    };
    ...
    ;
    if (v instanceof Right) {
      return mapMaybe(spanOf)(v.value0);
    }
    ;
    throw new Error("Failed pattern match at FlatBars.Highlight (line 59, column 26 - line 61, column 43): " + [v.constructor.name]);
  };
};
    ...
    return function(src) {
            ...
            var collect2 = function($copy_j) {
              return function($copy_chars) {
                ...
                function $tco_loop(j, chars) {
                  ...
                  if (v instanceof Just) {
                    ...
                    if (v.value0 === "\\") {
                      ...
                      if (v1 instanceof Just) {
                        ...
                        ;
                        throw new Error("Failed pattern match at FlatBars.Token (line 156, column 23 - line 158, column 76): " + [v2.constructor.name]);
                      }
                      ;
                      if (v1 instanceof Nothing) {
                        $tco_done = true;
                      ...
                      ;
                      throw new Error("Failed pattern match at FlatBars.Token (line 155, column 24 - line 159, column 76): " + [v1.constructor.name]);
                    }
                    ;
                    if (otherwise) {
                      $tco_var_j = j + 1 | 0;
                  ...
                  ;
                  throw new Error("Failed pattern match at FlatBars.Token (line 151, column 23 - line 160, column 60): " + [v.constructor.name]);
                }
                ;
                while (!$tco_done) {
      ...
      var readNumber = function(start) {
        return function(acc) {
          ...
          ;
          throw new Error("Failed pattern match at FlatBars.Token (line 140, column 7 - line 142, column 87): " + [v.constructor.name]);
        };
      };
        ...
        return function(acc) {
          var bracketEnd = function($copy_k) {
            ...
            function $tco_loop(k) {
              ...
              ;
              throw new Error("Failed pattern match at FlatBars.Token (line 129, column 5 - line 132, column 39): " + [k.constructor.name]);
            }
            ;
            while (!$tco_done2) {
          ...
          var scan = function($copy_j) {
            ...
            function $tco_loop(j) {
              ...
              if (v instanceof Just && v.value0 === "[") {
                ...
                ;
                throw new Error("Failed pattern match at FlatBars.Token (line 124, column 19 - line 126, column 71): " + [v1.constructor.name]);
              }
              ;
        ...
        return function($copy_acc) {
          ...
          function $tco_loop(i, acc) {
            ...
            if (otherwise) {
              ...
              ;
              throw new Error("Failed pattern match at FlatBars.Token (line 87, column 19 - line 112, column 31): " + [v.constructor.name]);
            }
            ;
            throw new Error("Failed pattern match at FlatBars.Token (line 84, column 3 - line 84, column 68): " + [i.constructor.name, acc.constructor.name]);
          }
          ;
          while (!$tco_done4) {
                ...
                function $tco_loop(acc, i) {
                  ...
                  if (v instanceof Just) {
                    ...
                    if (v.value0 instanceof RSep) {
                      ...
                      ;
                      throw new Error("Failed pattern match at FlatBars.Parser (line 368, column 27 - line 370, column 61): " + [v1.constructor.name]);
                    }
                    ;
                    if (v.value0 instanceof RClose) {
                      ...
                      ;
                      throw new Error("Failed pattern match at FlatBars.Parser (line 371, column 26 - line 373, column 63): " + [v1.constructor.name]);
                    }
                    ;
                    ...
                    ;
                    throw new Error("Failed pattern match at FlatBars.Parser (line 350, column 15 - line 385, column 64): " + [v.value0.constructor.name]);
                  }
                  ;
                  throw new Error("Failed pattern match at FlatBars.Parser (line 348, column 14 - line 385, column 64): " + [v.constructor.name]);
                }
                ;
                while (!$tco_done) {
                      ...
                      return function(i) {
                        ...
                        if (v instanceof Right) {
                          ...
                          if (v1 instanceof Right) {
                            ...
                            ;
                            throw new Error("Failed pattern match at FlatBars.Parser (line 400, column 26 - line 405, column 79): " + [v1.value0.stop.constructor.name]);
                          }
                          ;
                          throw new Error("Failed pattern match at FlatBars.Parser (line 398, column 9 - line 405, column 79): " + [v1.constructor.name]);
                        }
                        ;
                        throw new Error("Failed pattern match at FlatBars.Parser (line 388, column 40 - line 405, column 79): " + [v.constructor.name]);
                      };
                    };
                  };
                };
...
var buildFromTokens = function(opts) {
  return function(toks) {
    return bind4(parseSeq(opts.parseExpr)(opts.parseHead)(opts.extras)(opts.inheritance)(opts.lexOptions)(filter(function($148) {
...
var stringifyM = function(dictMonadThrow) {
  var $694 = liftEither(dictMonadThrow);
  return function($695) {
    return $694(stringify2($695));
  };
};
...
var toIntH = function(dictMonadThrow) {
  ...
  return function(v) {
    return bind9(stringifyM1(v))(function(s) {
      return pure4(maybe(VNull.value)(function($696) {
        return VNumber.create(trunc($696));
      })(fromString(s)));
    });
  };
};
var strUnary = function(dictMonadThrow) {
  ...
  return function(f) {
    return function(v) {
      return map32(function($697) {
        return VString.create(f($697));
      })(stringifyM1(v));
    };
  };
};
    ...
    return function(xv) {
      var isJustPrefix = function(p) {
        return function(str2) {
          ...
          ;
          throw new Error("Failed pattern match at Kernel.Prelude (line 562, column 24 - line 564, column 21): " + [v.constructor.name]);
        };
      };
...
var reverseCodeUnits = function($698) {
  return fromCharArray(reverse(toCharArray($698)));
};
var reverseH = function(dictMonadThrow) {
  ...
  return function(v) {
    ...
    ;
    return map32(function($699) {
      return VString.create(reverseCodeUnits($699));
    })(stringifyM1(v));
  };
};
    ...
    return function(args) {
      ...
      var renderPartial = function(name2) {
        return function(ctx2) {
          ...
          if (v instanceof Just) {
            ...
            if (otherwise) {
              ...
              var scoped = function() {
                ...
                ;
                throw new Error("Failed pattern match at Kernel.Prelude (line 1100, column 22 - line 1102, column 33): " + [v1.constructor.name]);
              }();
          ...
          ;
          throw new Error("Failed pattern match at Kernel.Prelude (line 1092, column 28 - line 1107, column 63): " + [v.constructor.name]);
        };
      };
  ...
  return function(opts) {
    return function(v) {
      return truthy(function() {
        var $529 = optFlag("includeZero")(opts);
        if ($529) {
    ...
    return function(clauses) {
      ...
      if (v instanceof Just) {
        ...
        if (v.value0.head.name === "elif") {
              ...
              return bind9(ctl["eval"](ctl.env)(condE))(function(cond) {
                return bind9(function() {
                  if (mOpts instanceof Nothing) {
                    return pure4(truthy(refFalsy(ctl.env))(cond));
                  }
                  ;
                  ...
                  ;
                  throw new Error("Failed pattern match at Kernel.Prelude (line 883, column 16 - line 886, column 18): " + [mOpts.constructor.name]);
                }())(function(hit) {
                  if (hit) {
                    return renderSafe1(ctl)(ctl.env)(v.value0.head.body);
                  }
          ...
          ;
          return throwError2(new ClauseError("elif: expected 1 or 2 arguments"));
        }
        ;
        return throwError2(new ClauseError("if: unexpected clause '" + (v.value0.head.name + "'")));
      }
      ;
      throw new Error("Failed pattern match at Kernel.Prelude (line 869, column 26 - line 888, column 82): " + [v.constructor.name]);
    };
  };
};
...
var indexValue = function(v) {
  return function(v1) {
    ...
    if (v instanceof VArray && v1 instanceof VString) {
      ...
      ;
      throw new Error("Failed pattern match at Kernel.Prelude (line 804, column 38 - line 806, column 19): " + [v2.constructor.name]);
    }
    ;
    return VNull.value;
  };
...
var lookupH = function(dictMonadThrow) {
  ...
  return function(v) {
    return function(args) {
      ...
      ;
      throw new Error("Failed pattern match at Kernel.Prelude (line 792, column 18 - line 794, column 59): " + [v1.constructor.name]);
    };
  };
};
  ...
  return function(sv) {
    return function(xv) {
      if (sv instanceof VArray) {
        return pure4(new VBool(elem6(xv)(sv.value0)));
      }
      ;
      ...
      return bind9(stringifyM1(keyv))(function(key) {
        if (av instanceof VArray) {
          return bind9(foldM2(insertGroup(key))(empty3)(av.value0))(function(grouped) {
            return pure4(new VObject(map23(function($702) {
              return VArray.create(reverse($702));
            })(grouped)));
          });
        }
        ;
        return pure4(new VObject(empty3));
      });
    };
  };
};
...
var escJsonH = function(dictMonadThrow) {
  ...
  return function(v) {
    return function(args) {
      return map32(function($703) {
        return VSafe.create(escapeHtml($703));
...
var escHtml = function(dictMonadThrow) {
  ...
  return function(v) {
    ...
    ;
    return map32(function($704) {
      return VSafe.create(escapeHtml($704));
    })(stringifyM1(v));
  };
};
    ...
    return function(xv) {
      var isJustSuffix = function(sfx) {
        return function(str2) {
          ...
          ;
          throw new Error("Failed pattern match at Kernel.Prelude (line 572, column 26 - line 574, column 21): " + [v.constructor.name]);
        };
      };
      return bind9(stringifyM1(sv))(function(s) {
        return bind9(stringifyM1(xv))(function(x) {
        ...
        return function($copy_acc) {
          ...
          function $tco_loop(as, acc) {
            ...
            if (v1 instanceof Just && v1.value0.head instanceof VString) {
              ...
              ;
              throw new Error("Failed pattern match at Kernel.Prelude (line 1057, column 39 - line 1059, column 73): " + [v2.constructor.name]);
            }
            ;
            if (v1 instanceof Just) {
              $tco_done = true;
            ...
            ;
            throw new Error("Failed pattern match at Kernel.Prelude (line 1055, column 18 - line 1060, column 66): " + [v1.constructor.name]);
          }
          ;
          while (!$tco_done) {
...
var countH = function(dictApplicative) {
  ...
  return function(v) {
    ...
    ;
    if (v instanceof VObject) {
      return pure4(new VNumber(toNumber(size2(v.value0))));
    }
    ;
...
var clampIndex = function(len) {
  return function(i) {
    ...
    ;
    throw new Error("Failed pattern match at Kernel.Prelude (line 536, column 1 - line 536, column 32): " + [len.constructor.name, i.constructor.name]);
  };
};
var checkIfClauses = function(dictMonadThrow) {
  ...
  return function(clauses) {
    ...
    ;
    throw new Error("Failed pattern match at Kernel.Prelude (line 895, column 26 - line 905, column 82): " + [v.constructor.name]);
  };
};
...
var capitalizeStr = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at Kernel.Prelude (line 462, column 19 - line 464, column 68): " + [v.constructor.name]);
};
...
var trimEndStr = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at Kernel.Prelude (line 478, column 16 - line 480, column 68): " + [v.constructor.name]);
};
var trimStartStr = function(s) {
  ...
  ;
  throw new Error("Failed pattern match at Kernel.Prelude (line 473, column 18 - line 475, column 31): " + [v.constructor.name]);
};
    ...
    return function(args) {
      ...
      if (v instanceof Just) {
        ...
        if (v.value0.head instanceof VArray) {
          var $644 = $$null(v.value0.head.value0);
          if ($644) {
            return renderElse1(ctl);
          }
          ;
      ...
      ;
      throw new Error("Failed pattern match at Kernel.Prelude (line 942, column 18 - line 963, column 84): " + [v.constructor.name]);
    };
  };
};
var withH = function(dictMonadThrow) {
  ...
  return function(ctl) {
    return function(args) {
      var v = uncons(args);
      if (v instanceof Just) {
        var $655 = truthy(refFalsy(ctl.env))(v.value0.head);
        if ($655) {
      ...
      ;
      throw new Error("Failed pattern match at Kernel.Prelude (line 1033, column 18 - line 1046, column 84): " + [v.constructor.name]);
    };
  };
};
...
var numUnary = function(dictMonadThrow) {
  ...
  return function(f) {
    return function(v) {
      return map32(function($705) {
        return VNumber.create(f($705));
      })(asNum1(v));
    };
  };
};
var asInt = function(dictMonadThrow) {
  ...
  var asNum1 = asNum(dictMonadThrow);
  return function(v) {
    return map32(function($706) {
      return round2(trunc($706));
    })(asNum1(v));
  };
};
            ...
            return bind9(stringifyM1(sv))(function(s) {
              return bind9(asInt1(startv))(function(start) {
                ...
                return bind9(function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at Kernel.Prelude (line 526, column 12 - line 528, column 30): " + [mEndv.constructor.name]);
                }())(function(end) {
  ...
  return function(ctl) {
    return function(args) {
      ...
      if (v instanceof Just && v.value0.head instanceof VString) {
        ...
        ;
        throw new Error("Failed pattern match at Kernel.Prelude (line 1064, column 40 - line 1066, column 47): " + [v1.constructor.name]);
      }
      ;
...
var coreHelperDefs = function(dictMonadThrow) {
  ...
  return [gen("this")(false)(new Exactly(0))(thisH(Applicative0)), gen("lookup")(false)(new AtLeast(1))(lookupH(dictMonadThrow)), valDef1("true")(nullary2(pure4(new VBool(true)))), valDef1("false")(nullary2(pure4(new VBool(false)))), valDef1("null")(nullary2(pure4(VNull.value))), valDef1("escapeHtml")(unary2(escHtml(dictMonadThrow))), valDef1("safe")(unary2(safe(dictMonadThrow))), gen("json")(false)(new Between(1, 2))(jsonH(dictMonadThrow)), gen("escapeJson")(false)(new Between(1, 2))(escJsonH(dictMonadThrow)), gen("raw")(true)(AnyArity.value)(rawH(dictMonadThrow)), gen("if")(true)(new Between(1, 2))(ifH(dictMonadThrow)), gen("unless")(true)(new Between(1, 2))(unlessH(dictMonadThrow)), gen("each")(true)(new AtLeast(1))(eachH(dictMonadThrow)), gen("with")(true)(new AtLeast(1))(withH(dictMonadThrow)), valDef1("else")(nullary2(pure4(new VSafe("")))), gen("elif")(false)(new Between(1, 2))(function(v) {
    return function(v1) {
      return pure4(new VSafe(""));
    };
...
var parseMin = function(src) {
  return bind7(tokenizeTemplate(minLexConfig)(src))(function(toks) {
...
var renderDiag = function(src) {
  return function(dat) {
    ...
    ;
    if (v instanceof Right) {
      return lmap3(formatError(src))(runResolved3(v.value0.directives)(identity7)(v.value0.nodes)(dat));
    }
    ;
...
var highlightConfig = /* @__PURE__ */ function() {
  ...
  return function(v) {
    if (v === "maxbars") {
      return {
        lexConfig: maxOptions.lexConfig,
...
var compileResult = function(dictShow) {
  ...
  return function(v) {
    ...
    ;
    throw new Error("Failed pattern match at FullBars.JS (line 116, column 17 - line 118, column 49): " + [v.constructor.name]);
  };
};
...
var compileMinbarsWithPartials = function(partials, tpl) {
  return compileResult1(compileMinJsWith(toUnfoldable8(partials))(tpl));
};
var compileMinbars = function(tpl) {
  return compileResult1(compileMinJs(tpl));
};
...
var rexpr = function(v) {
  ...
  ;
  if (v instanceof App2 && v.value1.length === 0) {
    var $58 = elem8(v.value0)(dataVars);
    if ($58) {
  ...
  ;
  throw new Error("Failed pattern match at FullBars.JS (line 272, column 9 - line 281, column 99): " + [v.constructor.name]);
};
...
var $lazy_rnode = /* @__PURE__ */ $runtime_lazy6("rnode", "FullBars.JS", function() {
  var children = function(ns) {
    return arr(map24($lazy_rnode(248))(ns));
  };
  return function(v) {
    ...
    if (v instanceof ROut) {
      ...
      ;
      throw new Error("Failed pattern match at FullBars.JS (line 222, column 21 - line 229, column 10): " + [v1.constructor.name]);
    }
    ;
    if (v instanceof RIf) {
    ...
    var v1 = function(v2) {
      var v3 = function(v4) {
        ...
        ;
        throw new Error("Failed pattern match at FullBars.JS (line 217, column 1 - line 217, column 23): " + [v.constructor.name]);
      };
      if (v instanceof RCall && v.value0 === "partial") {
        var $97 = litName(v.value1);
        if ($97 instanceof Just) {
          return obj([tt2("partial"), new Tuple("name", str($97.value0)), new Tuple("body", children(v.value2))]);
        }
        ;
        return v3(true);
      }
    ...
    if (v instanceof RCall && v.value0 === "inline") {
      var $103 = litName(v.value1);
      if ($103 instanceof Just) {
        return obj([tt2("inline"), new Tuple("name", str($103.value0)), new Tuple("body", children(v.value2))]);
      }
      ;
      return v1(true);
    }
...
var rnode = /* @__PURE__ */ $lazy_rnode(217);
var astJson = function(dialect, src) {
  var v = function() {
    var $108 = dialect === "maxbars";
    if ($108) {
  ...
  ;
  throw new Error("Failed pattern match at FullBars.JS (line 160, column 3 - line 189, column 12): " + [v.constructor.name]);
};
export {
  astJson,
  compile2 as compile,

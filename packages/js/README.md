...
A thin, JS/TS-friendly facade over the [FlatBars](../flatbars) reference engine
...
```js
import { render, renderSurface } from "barebars-js"; // FlatBars.JS
...
[`index.d.ts`](index.d.ts) for the TypeScript surface and [`FlatBars.JS`](src/FlatBars/JS.purs)
